...
public class ImportJobConfiguration {
	...
	public Job job() throws Exception {
		return this.jobBuilderFactory.get("importJob5")
	...
	// validate data (customer must already be in the db)
	// update customer data (will not update any empty fields from the csv file)
	@Bean
	...
	// read transactions from DB and update account data
	@Bean
	...
	// read customer, account and transaction data to create statements.
	// then create a statement file for each customer
	@Bean
