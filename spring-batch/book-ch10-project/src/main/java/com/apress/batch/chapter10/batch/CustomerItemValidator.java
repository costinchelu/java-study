...
public class CustomerItemValidator implements Validator<CustomerUpdate> {
	...
	protected static final String FIND_CUSTOMER = "SELECT COUNT(*) FROM CUSTOMER3 WHERE customer_id = :id";
	...
	public void validate(CustomerUpdate customer) throws ValidationException {
		...
		if(count != null && count == 0) {
			throw new ValidationException(String.format("Customer id %s was not found", customer.getCustomerId() ));
		}
	}
}
